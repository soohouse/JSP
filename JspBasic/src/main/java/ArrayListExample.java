...
//	nick.add(50); (x)
	nick.add("야옹이");
	System.out.println(nick); //중복을 허용합니다.
...
//	String name = nick[3]; (x)
	...
	//향상 for문(forEach)
	//우항엔 내가 돌리고싶은 리스트의 이름, 
	//좌항엔 안의 요소를 받아낼 수 있는 매개변수하나설정, 
	//타입은 처음의 제네릭 타입.
	for(String n : nick) {
	...
	//컬렉션 내에서 등장 횟수 구하기
	System.out.println("100점 학생 수: " + Collections.frequency(score, score));
